...
//       { id: 5, img: '6.png', title: 'Свиные ребрышки на гриле с зеленью', subtitle: 'Не следует, однако забывать...', price: 1600 },
...
export default createStore({
  state: loadState() || {
    ...
    allPriceProductsInBasket: 0,
    products: [
      { id: 1, img: '/Restaurant/img/1.png', title: 'Устрицы по рокфеллеровски', subtitle: 'Значимость этих проблем настолько очевидна...', price: 2700 },
      { id: 2, img: '/Restaurant/img/2.png', title: 'Свиные ребрышки на гриле с зеленью', subtitle: 'Не следует, однако забывать...', price: 1600 },
      { id: 3, img: '/Restaurant/img/4.png', title: 'Креветки по-королевски в лимонном соке', subtitle: 'Значимость этих проблем настолько очевидна...', price: 1820 },
      { id: 4, img: '/Restaurant/img/5.png', title: 'Устрицы по рокфеллеровски', subtitle: 'Значимость этих проблем настолько очевидна...', price: 2700 },
      { id: 5, img: '/Restaurant/img/6.png', title: 'Свиные ребрышки на гриле с зеленью', subtitle: 'Не следует, однако забывать...', price: 1600 },
      { id: 6, img: '/Restaurant/img/4.png', title: 'Креветки по-королевски в лимонном соке', subtitle: 'Значимость этих проблем настолько очевидна...', price: 1820 },
      { id: 7, img: '/Restaurant/img/2.png', title: 'Свиные ребрышки на гриле с зеленью', subtitle: 'Не следует, однако забывать...', price: 1600 },
      { id: 8, img: '/Restaurant/img/5.png', title: 'Устрицы по рокфеллеровски', subtitle: 'Значимость этих проблем настолько очевидна...', price: 2700 }
    ],
    basketProducts: []
  },
  getters: {
